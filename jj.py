...
def hypothesis_calculator(data):
    ...
    for index,rows in data.iterrows():
        ...
        #print (temp)
        hyp_list.append(sigmoid_sum(sum(temp)))
    print (hyp_list)
    return [b_i - a_i for a_i, b_i in zip(hyp_list, actual_values)]
...
if __name__ == '__main__':
    path = "/Users/vigneshsureshbabu/Desktop/logreg.csv"
